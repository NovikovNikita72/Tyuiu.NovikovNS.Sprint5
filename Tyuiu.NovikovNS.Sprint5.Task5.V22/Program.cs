...
using System.IO;
using Tyuiu.NovikovNS.Sprint5.Task5.V22.Lib;

namespace Tyuiu.NovikovNS.Sprint5.Task5.V22
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* целое число в файле, которое делится на 4. Полученный результат вывести *");
            Console.WriteLine("* на консоль. У вещественных значений округлить до трёх знаков после ,    *");
            Console.WriteLine("***************************************************************************");
